      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 md:px-6 py-5">
        {config && (
          <div className="max-w-[640px] space-y-8">
            ...
            {/* Heartbeat */}
            <Section id="heartbeat" title="Heartbeat" description="Periodic self-check. Claw reviews markets, news and alerts at the configured interval, and only pushes a notification when there's something worth your attention. Interval format: 30m, 1h, 6h.">
